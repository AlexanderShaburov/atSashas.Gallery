...
Blocks can reference Events (existing or extended behavior)
...
Home is driven by HomeDoc.items[]

Home Editor supports:
...
CTA is visible directly on Home

No breaking changes to Journey / Editors
