...
SAMPLE_EVENT_PAGES = {
    ...
    "pages": {
        ...
        # Phase 2: capacity-constrained event (single seat) for capacity tests.
        "event-20260421-cap001": {
            "id": "event-20260421-cap001",
            "slug": "capacity-one",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Capacity One Workshop"},
            "description": {"en": "Single seat"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
            "ctaAction": {"kind": "register", "paid": False, "capacity": 1},
        },
        # Phase 2: event where capacity will be reached by test setup (capacity=2).
        "event-20260421-cap002": {
            "id": "event-20260421-cap002",
            "slug": "capacity-two",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Capacity Two Workshop"},
            "description": {"en": "Two seats"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
            "ctaAction": {"kind": "register", "paid": False, "capacity": 2},
        },
        # Phase 3: dedicated event for the overview paid-count test. Kept
        # isolated from Phase 2's cap001/cap002 so full-suite ordering does
        # not interfere.
        "event-20260421-ovw001": {
            "id": "event-20260421-ovw001",
            "slug": "overview-paid",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Overview Paid-Count Workshop"},
            "description": {"en": "Phase 3 fixture"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        # Phase 5A fixtures. Kept unique-per-test where full-suite ordering
        # could pollute state. Each has a descriptive suffix for debugging.
        "event-20260421-p5status": {
            "id": "event-20260421-p5status",
            "slug": "p5-status",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Status Tests"},
            "description": {"en": "Status PATCH fixture"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        "event-20260421-p5pay": {
            "id": "event-20260421-p5pay",
            "slug": "p5-pay",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Payment Tests"},
            "description": {"en": "Payment PATCH fixture"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        "event-20260421-p5contact": {
            "id": "event-20260421-p5contact",
            "slug": "p5-contact",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Contact Tests"},
            "description": {"en": "Contact PATCH fixture"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        "event-20260421-p5create": {
            "id": "event-20260421-p5create",
            "slug": "p5-create",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Manual Create Tests"},
            "description": {"en": "Admin create fixture"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        "event-20260421-p5createfull": {
            "id": "event-20260421-p5createfull",
            "slug": "p5-create-full",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Manual Create Capacity"},
            "description": {"en": "Capacity=1"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
            "ctaAction": {"kind": "register", "paid": False, "capacity": 1},
        ...
        "event-20260421-p5trsrc": {
            "id": "event-20260421-p5trsrc",
            "slug": "p5-transfer-src",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Transfer Source"},
            "description": {"en": "Unbounded transfer source"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
        },
        "event-20260421-p5trdst": {
            "id": "event-20260421-p5trdst",
            "slug": "p5-transfer-dst",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Transfer Destination"},
            "description": {"en": "capacity=2"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
            "ctaAction": {"kind": "register", "paid": False, "capacity": 2},
        },
        "event-20260421-p5trfull": {
            "id": "event-20260421-p5trfull",
            "slug": "p5-transfer-full",
            "preset": "workshop",
            "status": "scheduled",
            "title": {"en": "Phase 5A — Transfer Destination (full)"},
            "description": {"en": "capacity=1 filled in test setup"},
            "location": {"en": "Studio"},
            "ctaLabel": {"en": "Enroll"},
            "enrollments": {},
            "ctaAction": {"kind": "register", "paid": False, "capacity": 1},
