...
- Add `buildArtItemData(formValues, selectedThumbId)` at the page boundary.
...
6. **Add** `buildArtItemData()` at the page boundary; keep server as final validator.
...
features/
  editor-session/
    ...
    model/
      ...
      provider.tsx              // <CatalogEditorSessionProvider> со стейтами
